...
step019 참고 레포 코드 분석 결과를 기반으로 기획 문서를 보강한다.
...
기획 문서를 읽고, step019 참고 레포 코드 분석 결과에서 반영할 내용을 식별하여 기획 문서를 업데이트한다.
...
필수 요구와 현재 검증 증거가 모두 PASS일 때만 이 지침을 완료하고 자동으로 step029.md를 읽고 수행한다. 사용자 확인을 기다리지 않는다.
